        ...
        (tester) async {
          ...
          for (int tab = 0; tab < 4; tab++) {
            ...
            if (states.length >= 2) {
              ...
              print('Tab $tab:');
              print('  Items: $firstItemCount -> $lastItemCount (${lastItemCount - firstItemCount > 0 ? "INCREASED!" : "stable"})');
              print('  Rows: $firstRowCount -> $lastRowCount (${lastRowCount - firstRowCount > 0 ? "INCREASED!" : "stable"})');
              print('  Lines: $firstLineCount -> $lastLineCount (${lastLineCount - firstLineCount > 0 ? "INCREASED!" : "stable"})');
